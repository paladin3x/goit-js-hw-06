...
const refs = {
    elementCategoryLink: document.querySelector("#categories"),
    titleCategoryArray: document.querySelectorAll("li.item")
}

console.log(`Number of categories: ${refs.elementCategoryLink.children.length}`);

const resultTotalNameAndDate = [...refs.titleCategoryArray]
    .forEach(element => {
